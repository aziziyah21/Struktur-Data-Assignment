...
int main(){
    ...
    nodeA = alokasi("Aerostreet", 158, 250000);
    nodeB = alokasi("Brodo", 121, 420000);
    nodeC = alokasi("Rebook", 98, 370000);
    nodeD = alokasi("Nineten", 69, 415000);
    nodeE = alokasi("Adidas", 36, 650000);
   ...
   updateAfter(List, nodeD);
    ...
    FindNodeByData(List, "Kanky");
    FindNodeByAddress(List, nodeC);
    FindNodeByRange(List, 6600, 276000);
...
### [output]
<img width="1271" height="944" alt="Screenshot 2025-10-30 043545" src="https://github.com/user-attachments/assets/08e23037-8aa4-4b6f-910b-fb5761869072" />
<img width="875" height="385" alt="Screenshot 2025-10-30 043607" src="https://github.com/user-attachments/assets/77517d03-319f-4d45-86af-8e8a22ea2c92" />
